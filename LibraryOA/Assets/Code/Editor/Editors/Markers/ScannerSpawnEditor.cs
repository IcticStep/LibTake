...
{
    [CustomEditor(typeof(ScannerSpawn))]
    internal sealed class ScannerSpawnEditor : UnityEditor.Editor 
    {
        ...
        public static void RenderCustomGizmo(ScannerSpawn spawn, GizmoType gizmo)
        {
            InitStaticData();
