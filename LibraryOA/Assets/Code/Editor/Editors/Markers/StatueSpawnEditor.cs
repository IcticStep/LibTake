...
{
    [CustomEditor(typeof(StatueSpawnMarker))]
    internal sealed class StatueSpawnEditor : UnityEditor.Editor 
    {
        ...
        public static void RenderCustomGizmo(StatueSpawnMarker spawn, GizmoType gizmo)
        {
            InitStaticData();
